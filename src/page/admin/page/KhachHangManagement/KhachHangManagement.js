...
import useGetDataKhachHang from "./hook/useGetDataKhachHang";
...
const KhachHangManagement = () => {
  ...
  // Get Data
  const { khachHangData, isDataLoading, fetchData, isFetching } =
    useGetDataKhachHang("0", "0");
