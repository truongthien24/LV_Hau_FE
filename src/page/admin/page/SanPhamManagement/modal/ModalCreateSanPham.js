...
import useCreateSanPham from "../hook/useCreateSanPham";
...
export const ModalCreateSanPham = (props) => {
  // Props
  ...
  const { mutate, isLoading: isSubmitting } = useCreateSanPham();
  ...
  const handleSubmitData = async (data) => {
    await mutate({
      Data: { ...data, tinhTrang: parseInt(data?.tinhTrang) },
      onSuccess: async (msg) => {
